...
def main():
    ...
    parser.add_argument('--model', type=str, default='StyleID', help='Print with the metrics.')
    ...
    with open('eval_results.txt', 'a') as f:
        f.write(f'Model: {args.model}, ArtFID: {artfid:.4f}, FID: {fid:.4f}, LPIPS: {lpips:.4f}, LPIPS_gray: {lpips_gray:.4f}, CFSD: {cfsd}\n')
