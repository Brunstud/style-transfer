...
def parse_args():
    ...
    parser.add_argument('--sub_exp_name', type=str,
                        default="workdir/test", help='sub exp name')
    parser.add_argument('--content_img_folder', type=str,
                        default="../StyleID/data/cnt", help='content image paths')
    parser.add_argument('--style_img_folder', type=str,
                        default="../StyleID/data/sty", help='style image paths')
    parser.add_argument('--pkl_dir', type=str, default="workdir/cache")
